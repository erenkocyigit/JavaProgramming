...
*/
        ...
        for (Map<String, String> eachScrumTeam : scrumTeams) {
            for (Map.Entry<String, String> eachScrumMember : eachScrumTeam.entrySet()) {
                if (eachScrumMember.getValue().equalsIgnoreCase("Developer")){
                    System.out.println(eachScrumMember.getKey());
                }
            }
        }
